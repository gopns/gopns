//Forked from https://github.com/msbranco/goconfig
...
func ReadConfig(configReader io.Reader) (*ConfigFile, error) {

	c := NewConfigFile()
	if err := c.read(bufio.NewReader(configReader)); err != nil {
		return nil, err
	}
